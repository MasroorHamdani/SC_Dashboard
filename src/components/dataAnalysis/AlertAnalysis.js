...
import {ALERT_STATUS, DATE_TIME_FORMAT,
    ...
    HOUR_MIN_FORMAT, DEVICE_TYPE, ALERT_STATUS_COLOR} from '../../constants/Constant';
    ...
    render() {
        ...
        return (
            <div className={isDashboard? classes.dashboardRoot : classes.root}>
                ...
                {showFilter &&
                    <div>
                        <div className={classes.alertTileRow}>
                            {Object.keys(stateData.alertCount).map((key, index) => {
                                return <div className={classes.alertTile}
                                    key={index}
